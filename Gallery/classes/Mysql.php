...
class Mysql{
                ...
                if( !empty($save[5]) ){
                    ...
                    if( !empty($save[2]) ){
                        ...
                        $str_where = preg_replace_callback(
                            ...
                            create_public function('$m', 'return "{$m[1]} {$m[2]} '.$tbl.'.{$m[3]}";'),
                            $str_where
                        );
                    }
                }
    ...
    public function db_row_array($query){
        $result = db_query($query);
    ...
    public function db_insert($table, $param, $is_replace = false){
        $is_set_a = false;
    ...
    public function db_sql_select($param = array()){
    ...
    public function db_get_fk($ref_tbl){
    ...
    public function db_set_fk($tbl, $fld, $ref_tbl, $ref_fld){
    ...
    public function db_drop_fk($tbl, $fld, $ref_tbl, $ref_fld){
        $tbl = str_replace('{#DB_PF#}', DB_PF, $tbl);
        $ref_tbl = str_replace('{#DB_PF#}', DB_PF, $ref_tbl);
    ...
    public function db_get_str2array($table, $str, $type = 'ARRAY'){
        $data = array();
